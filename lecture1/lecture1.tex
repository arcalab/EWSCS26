...
\begin{frame}{From equations to metric equations}
        ...
        Goal: present a \alert{metric equational system}
...
\begin{frame}{Programme}
        ...
        \pause
        \bigskip
        Lecture 3 : framework for relating progrs. w.r.t.  \alert{distances}
...
\begin{frame}{Linear $\lambda$-calculus}
  ...
  \begin{flalign*}
      \hspace{-0.2cm}
      \infer[]{\Gamma \vljud \lambda x.\ t : \typeA \multimap \typeB}
      {
...
\begin{frame}{Examples of $\lambda$-terms}
  \begin{flalign*}
          ...
          \lambda x. \> g (f (x)) : \alert{\typeA \multimap \typeC}
          && \text{(composition)}
  \end{flalign*}
        ...
        \begin{examples}
                \begin{itemize}
                        ...
                        \item $(\text{pm } x \text{ to } x_1 \otimes x_2. \>
                                s) \> [t/x] = 
                                \text{pm } t \text{ to } x_1 \otimes x_2. \> s[t/x]$
                \end{itemize}
        \end{examples}
...
%  \pause
%  \bigskip
%  Crucial to the equational system of linear $\lambda$-calculus 
%\end{frame}
